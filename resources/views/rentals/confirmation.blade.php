            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="p-6 lg:p-8">
                            ...
                            <div class="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-yellow-800 dark:text-yellow-400 leading-relaxed">
                                        <strong>Titan & Equity Resources Limited</strong> team will contact you shortly to verify your payment status and confirm your booking. Please keep your phone accessible.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-900/50 rounded-xl p-5 border border-gray-100 dark:border-gray-700">
                                ...
                                <div class="space-y-3">
                                    <div class="flex justify-between items-center">
                                        <span class="text-gray-600 dark:text-gray-400">Booking No.</span>
                                        <span class="font-mono font-bold text-gray-900 dark:text-white bg-gray-200 dark:bg-gray-700 px-3 py-1 rounded-lg text-sm">{{ $order->order_number }}</span>
                                    </div>
                                    <div class="flex justify-between items-center">
                                        <span class="text-gray-600 dark:text-gray-400">Check-in</span>
                                        <span class="font-semibold text-gray-900 dark:text-white">{{ \Carbon\Carbon::parse($order->details['check_in'])->format('M d, Y') }}</span>
                                    </div>
                                    <div class="flex justify-between items-center">
                                        <span class="text-gray-600 dark:text-gray-400">Check-out</span>
                                        <span class="font-semibold text-gray-900 dark:text-white">{{ \Carbon\Carbon::parse($order->details['check_out'])->format('M d, Y') }}</span>
                                    </div>
                                    <div class="flex justify-between items-center">
                                        <span class="text-gray-600 dark:text-gray-400">Duration</span>
                                        <span class="font-semibold text-gray-900 dark:text-white">{{ $order->details['days'] }} night{{ $order->details['days'] > 1 ? 's' : '' }}</span>
                                    </div>
                                    <div class="flex justify-between items-center">
                                        <span class="text-gray-600 dark:text-gray-400">Guests</span>
                                        <span class="font-semibold text-gray-900 dark:text-white">{{ $order->details['guests'] }} guest{{ $order->details['guests'] > 1 ? 's' : '' }}</span>
                                    </div>
                                    <div class="flex justify-between items-center">
                                        ...
                                        <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-sm font-semibold
                                            ...
                                            {{ $order->status === 'paid' ? 'Confirmed' : 'Pending Verification' }}
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-900/50 rounded-xl p-5 border border-gray-100 dark:border-gray-700">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div>
                                        <span class="text-gray-600 dark:text-gray-400 text-sm">Payment Method</span>
                        ...
                        <div class="mb-8 p-5 bg-purple-50 dark:bg-purple-900/20 rounded-xl border border-purple-200 dark:border-purple-800">
                            ...
                            <p class="text-purple-800 dark:text-purple-400">{{ $order->details['special_requests'] }}</p>
                        </div>
                        @endif
                        ...
                        <div class="mb-8 p-5 bg-primary-50 dark:bg-primary-900/20 rounded-xl border border-primary-200 dark:border-primary-800">
                            ...
                            <p class="text-primary-700 dark:text-primary-400 text-sm mb-4">If you haven't made the transfer yet, please use:</p>
                            ...
                            <div class="space-y-4">
                                <div class="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-blue-700 dark:text-blue-400">Our team will verify your bank transfer within 12 hours</p>
                                    </div>
                                </div>
                                <div class="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-blue-700 dark:text-blue-400">You'll receive a confirmation call from Titan & Equity team</p>
                                    </div>
                                </div>
                                <div class="flex gap-4">
                                    ...
                                    <div>
                                        <p class="font-semibold text-blue-900 dark:text-blue-300">Check-in Instructions</p>
                                        <p class="text-sm text-blue-700 dark:text-blue-400">Detailed check-in instructions will be sent 48 hours before arrival</p>
                                    </div>
                                </div>
                                <div class="flex gap-4">
                                    ...
                                    <div>
                                        <p class="font-semibold text-blue-900 dark:text-blue-300">Enjoy Your Stay!</p>
                                        <p class="text-sm text-blue-700 dark:text-blue-400">Welcome to your home away from home</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-8 p-5 bg-gray-100 dark:bg-gray-900/50 rounded-xl border border-gray-200 dark:border-gray-700">
                            <h4 class="font-bold text-gray-900 dark:text-white mb-3">Need Assistance?</h4>
                            <p class="text-gray-600 dark:text-gray-400 mb-4">Our team is here to help with your booking:</p>
                            <div class="flex flex-wrap gap-4">
                                ...
                                <a href="https://wa.me/2349115008562" target="_blank" class="inline-flex items-center gap-2 px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-colors">
