...
<head>
    ...
    <title>Admin Dashboard - Titan & Equity Resources</title>
        ...
        <nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="shrink-0 flex items-center">
                            ...
                            <span class="ml-2 text-xl font-semibold text-gray-900 dark:text-white">Admin Panel</span>
                        </div>
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <x-admin-nav-link :href="route('properties.index')" :active="request()->routeIs('admin.properties.*')">
                                {{ __('Properties') }}
                            </x-admin-nav-link>
                            <x-admin-nav-link :href="route('admin.blogs.index')" :active="request()->routeIs('admin.blog.*')">
                                {{ __('Blog') }}
                            </x-admin-nav-link>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <!-- Dark mode toggle -->
                        <button onclick="toggleDarkMode()" class="p-2 rounded-full text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none mr-4">
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <x-responsive-nav-link :href="route('properties.index')" :active="request()->routeIs('admin.properties.*')">
                        {{ __('Properties') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('admin.blogs.index')" :active="request()->routeIs('admin.blog.*')">
                        {{ __('Blog') }}
                    </x-responsive-nav-link>
