<x-app-layout>
                            ...
                            <div id="preview" class="mt-4">
                                @if($blog->image_url)
                                    <div id="current_image" class="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800">
                                        ...
                                        <img src="{{ $blog->image_url }}" class="w-full max-w-md rounded-lg shadow-md mx-auto mb-3">
                                        <p class="text-xs text-gray-600 dark:text-gray-400 break-all">{{ $blog->image_url }}</p>
                                    </div>
                                @endif
                            </div>

                            <input type="hidden" name="image_url" id="image_url" value="{{ $blog->image_url }}">
                            <input type="hidden" name="public_id" id="public_id" value="{{ $blog->public_id }}">
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Toggle Published At visibility
