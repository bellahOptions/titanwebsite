            ...
            <form method="POST" action="{{ route('admin.settings.update') }}" class="bg-white p-8 rounded-lg shadow-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="auto_approve_properties" class="block text-sm font-medium text-gray-700">Auto Approve Properties</label>
                            <select name="auto_approve_properties" class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2">
                                <option value="yes" {{ $settings->auto_approve_properties == 'yes' ? 'selected' : '' }}>Yes</option>
                                <option value="no" {{ $settings->auto_approve_properties == 'no' ? 'selected' : '' }}>No</option>
                            </select>
                        </div>
                    </div>
                </div>
